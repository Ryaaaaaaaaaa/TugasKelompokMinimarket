                    ...
                    response.forEach(function(product) {
                        ...
                        $('#product-list').append(`
                            <div class="border p-4 rounded-lg shadow-md">
                                ...
                                <button onclick="addToCart(${product.id}, '${product.name}', ${product.price}, ${product.stock})" class="px-4 py-2 ${product.stock > 0 ? 'bg-blue-500' : 'bg-gray-500 cursor-not-allowed'} text-white rounded-md ${product.stock > 0 ? 'hover:bg-blue-600' : ''}" ${product.stock <= 0 ? 'disabled' : ''}>
